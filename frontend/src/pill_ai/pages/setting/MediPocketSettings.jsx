...
const MANAGE_ITEMS = [
  ...
  { icon: "⚙️", label: "설정", path: "/app/setting", active: true },
];
...
function Sidebar() {
  ...
  return (
    <aside style={{
      ...
      <nav style={{ display: "flex", flexDirection: "column", gap: 2, marginBottom: 14 }}>
        {NAV_ITEMS.map(item => (
          <button key={item.path} onClick={() => navigate(item.path)} style={{
            ...
            background: "transparent", fontFamily: "'Plus Jakarta Sans', 'Noto Sans KR', sans-serif",
            fontSize: 13, fontWeight: 500, color: "#6b7280", cursor: "pointer", textAlign: "left", width: "100%",
          }}>
      ...
      <nav style={{ display: "flex", flexDirection: "column", gap: 2 }}>
        {MANAGE_ITEMS.map(item => (
          <button key={item.path} onClick={() => navigate(item.path)}  style={{
            ...
            color: item.active ? "#7c3aed" : "#6b7280", cursor: "pointer", textAlign: "left", width: "100%",
          }}>
            <span style={{ fontSize: 15, width: 20, textAlign: "center" }}>{item.icon}</span>
            <span>{item.label}</span>
            {item.badge && (
      ...
      <div style={{ flex: 1 }} />
      <div style={{ display: "flex", alignItems: "center", gap: 10, padding: "10px 8px", borderTop: "1px solid #e9e7f5", marginTop: 12 }}>
        <div style={{
        ...
        <div>
          <div style={{ fontSize: 13, fontWeight: 700, color: "#1a1433", fontFamily: "'Plus Jakarta Sans', sans-serif" }}>김민지</div>
          <div style={{ fontSize: 11, color: "#6b7280" }}>일반 사용자</div>
        </div>
      </div>
    </aside>
  );
...
function CardHeader({ label }) {
  return (
    <div style={{
      borderBottom: "0.8px solid #e9e7f5",
      paddingBottom: 10,
      marginBottom: 4,
    }}>
      <span style={{
        fontSize: 13, fontWeight: 700, color: "#6b5f8a",
...
function SettingsRow({ label, sub, right, noBorder }) {
  return (
    <div style={{
      ...
      padding: "14px 0",
      borderBottom: noBorder ? "none" : "0.8px solid #e9e7f5",
      gap: 12,
    }}>
      <div>
...
function SelectBadge({ label }) {
  return (
    <div style={{
      border: "0.8px solid #e9e7f5", borderRadius: 8,
      padding: "5px 14px", fontSize: 12, color: "#1a1433",
...
function ProfileCard() {
  ...
  return (
    <Card>
      ...
      <div style={{
        display: "flex", alignItems: "center", justifyContent: "space-between",
        background: "#f9f8ff", borderRadius: 12,
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 14 }}>
          ...
          <div>
            <div style={{ fontSize: 14, fontWeight: 700, color: "#1a1433" }}>김민지</div>
            <div style={{ fontSize: 12, color: "#9ca3af", marginTop: 2 }}>minji@email.com</div>
        ...
        <button style={{
          ...
          color: "#6b5f8a", background: "#fff", cursor: "pointer",
...
function SecurityCard() {
  ...
  return (
    <Card>
      ...
      <SettingsRow label="개인정보 처리방침" right={<span style={{ fontSize: 12, color: "#7c3aed" }}>보기 ›</span>} />

      <div style={{ marginTop: 10, display: "flex", flexDirection: "column", gap: 8 }}>
        <button style={{
          width: "100%", padding: "12px", background: "#fef2f2",
          border: "0.8px solid #fecaca", borderRadius: 10,
    ...
    <>
      <style>{`
        ...
        *, *::before, *::after { margin: 0; padding: 0; box-sizing: border-box; }
        body { font-family: 'Plus Jakarta Sans', 'Noto Sans KR', sans-serif; background: #f4f3ff; }
      ...
      <div style={{ display: "flex", minHeight: "100vh", background: "#f4f3ff" }}>
        ...
        <main style={{ flex: 1, padding: "36px 40px 48px", overflowY: "auto" }}>
          {/* 헤더 */}
          <div style={{ display: "flex", alignItems: "center", gap: 10, marginBottom: 28 }}>
            <span style={{ fontSize: 22 }}>⚙️</span>
            <h1 style={{ fontSize: 22, fontWeight: 800, color: "#1a1433" }}>설정</h1>
          </div>
